...
import net.training.ftgo.accountingservice.domain.Account;
import net.training.ftgo.accountingservice.domain.AccountCommand;
import net.training.ftgo.accountingservice.domain.AuthorizeCommandInternal;
import net.training.ftgo.accountingservice.messaging.AccountingMessagingConfiguration;
...
public class AccountingServiceCommandHandlerTest {
  ...
  public void shouldReply() throws InterruptedException, ExecutionException, TimeoutException {
    ...
    domainEventPublisher.publish("net.training.ftgo.consumerservice.domain.Consumer", consumerId, Collections.singletonList(new ConsumerCreated()));
