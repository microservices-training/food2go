...
import net.training.ftgo.orderservice.api.events.OrderDetails;
import net.training.ftgo.orderservice.api.events.OrderDomainEvent;
import net.training.ftgo.orderservice.api.events.OrderLineItem;
...
import net.training.ftgo.orderservice.web.MenuItemIdAndQuantity;
import net.training.ftgo.restaurantservice.events.MenuItem;
import net.training.ftgo.restaurantservice.events.RestaurantMenu;
