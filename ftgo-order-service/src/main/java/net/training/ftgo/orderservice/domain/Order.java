...
import net.training.ftgo.common.UnsupportedStateTransitionException;
import net.training.ftgo.orderservice.api.events.*;
...
import static net.training.ftgo.orderservice.api.events.OrderState.APPROVAL_PENDING;
import static net.training.ftgo.orderservice.api.events.OrderState.APPROVED;
import static net.training.ftgo.orderservice.api.events.OrderState.REJECTED;
import static net.training.ftgo.orderservice.api.events.OrderState.REVISION_PENDING;
