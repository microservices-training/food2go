package net.training.ftgo.orderservice.web;

import net.training.ftgo.orderservice.api.web.CreateOrderRequest;
import net.training.ftgo.orderservice.api.web.CreateOrderResponse;
import net.training.ftgo.orderservice.api.web.ReviseOrderRequest;
import net.training.ftgo.orderservice.domain.*;
