package net.training.ftgo.cqrs.orderhistory.main;

import io.eventuate.jdbckafka.TramJdbcKafkaConfiguration;
import net.training.eventstore.examples.customersandorders.commonswagger.CommonSwaggerConfiguration;
import net.training.ftgo.cqrs.orderhistory.messaging.OrderHistoryServiceMessagingConfiguration;
import net.training.ftgo.cqrs.orderhistory.web.OrderHistoryWebConfiguration;
