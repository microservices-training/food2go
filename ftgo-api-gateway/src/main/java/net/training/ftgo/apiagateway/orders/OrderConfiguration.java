package net.training.ftgo.apiagateway.orders;
...
import net.training.ftgo.apiagateway.proxies.AccountingService;
import net.training.ftgo.apiagateway.proxies.DeliveryService;
import net.training.ftgo.apiagateway.proxies.KitchenService;
import net.training.ftgo.apiagateway.proxies.OrderServiceProxy;
